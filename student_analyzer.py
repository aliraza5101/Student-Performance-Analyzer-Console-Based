...
class Student:
    ...
    def compute_final(self):
        ...
        final_score = (0.4 * midterm) + (0.5 * final) + (0.1 * assignment)
        """
...
# =============================================================================
def load_data():
    """On startup, load student records from CSV. Handle missing file errors."""
...
# =============================================================================
def add_student():
    """Allow the instructor to add a student record."""
    print("\n--- Add New Student ---")
    try:
...
def remove_student():
    """Allow the instructor to remove a student record."""
    print("\n--- Remove Student ---")
    try:
...
def search_student():
    """Allow the instructor to search for a student."""
    print("\n--- Search Student ---")
    try:
...
def update_student():
    """Allow the instructor to update student records."""
    print("\n--- Update Student ---")
    try:
...
def show_all_students():
    """Display all student records nicely."""
    print("\n--- All Student Records ---")
...
def visualize_grades():
    """
    Grade Visualization using ANSI Colors and Percentage.
    This creates a 'Pro' look in the console.
    """
    print("\n" + "="*45)
...
def main():
    ...
    print("=============================================================")
    print("=====      Student Performance Analyzer By Ali Raza     =====")
    print("=====   Taught by : Professor Dr. Wajid Arshad Abbasi   =====")
    print("=============================================================\n")
    print("1. Add Student")
